...
class Generator:
    ...
    def generate_league(self, year: str, progress_callback=None) -> structs.League:
        ...
        return structs.League(
            ...
            coachSettings={},
            career={},
            season=self._get_default_season_config(),
            currentGame=None,
        )
    ...
    def generate_ncaa_league(
        ...
        for tid, roster in team_map.items():
            ...
            for p in roster:
                ...
                struct_player = structs.Player(
                    ...
                    careerGoals={
                        "career": team_assets.empty_player_stats_block(),
                        "game": team_assets.empty_player_stats_block(),
                        "season": team_assets.empty_player_stats_block(),
                    },
                    records=0,
                )
                struct_roster.append(struct_player)
        ...
        commissioner_obj = {
            ...
            "careerGoals": {"career": 0, "game": 0, "season": 0},
            "gameStatus": {
                "startPos": 0,
                "stamina": 0,
                "gradePoints": 0,
            ...
            "careerStats": {
                "season": team_assets.empty_player_stats_block(),
                "seasonHighs": team_assets.empty_player_stats_block(),
                "playoffs": team_assets.empty_player_stats_block(),
                "playoffHighs": team_assets.empty_player_stats_block(),
                "finals": team_assets.empty_player_stats_block(),
                "finalsHighs": team_assets.empty_player_stats_block(),
            },
            "history": {
                "id": 0,
                "tid": 0,
                "coll": 0,
                "draft": {"pk": 0, "rd": 0, "tid": -1, "otid": -1, "yr": 0},
                "fantasyDrafts": [],
                "expansionDrafts": [],
                "injuries": [],
                "yearRetired": 0,
        ...
        return structs.League(
            ...
            contractOffers=[],
            awards=[],
            records=self._get_default_records(),
            settings=self._get_default_settings(),
            rules=self._get_ncaa_rules(),
            sliders=self._get_default_sliders(),
            difficulty=self._get_default_difficulty(),
            simulationSliders=self._get_default_sliders(),
            optimization={},
            coachSettings=self._get_default_coach_settings(),
            career=self._get_default_career(),
            season=self._get_default_season_config(),
            currentGame=None,
        )
    ...
    def _get_ncaa_rules(self) -> dict:
        return {
            ...
            "offGoaltending": True,
            "oneAndOne": True,
            "partialShotClock": True,
            "shootingFouls": True,
        }

    def _get_default_season_config(self) -> dict:
        return {
            "mode": 0,
            "teamId": 0,
            "playerId": 0,
            ...
            "lotteryOdds": [],
            "fantasyDraft": False,
            "expansionDraft": False,
            "customDraftClass": False,
            "declareAllPlayers": False,
            "allowOtherProspects": False,
            "draftRounds": 0,
            "classStrength": 0,
            "totalGames": 0,
            "divisionGames": 0,
            ...
            "salaryCap": 0,
            "maxContract": [10, 15, 20],
            "playoffTeams": 0,
            "seriesLength": [0, 0, 0, 0, 0, 0],
            "playInTournament": False,
            "simulationPace": 0,
            "progressionRate": 0,
            "injuryProbability": 0,
            "cpuTrading": True,
            "generatedFreeAgents": False,
            "ageAppearance": False,
            "hidePotential": False,
            "HOFbar": 10,
            "cpuRosterChanges": False,
            "cpuTradeBlock": True,
            "cpuProgression": False,
    ...
    def _get_default_career(self) -> dict:
        return {
            "coins": 0,
            "fame": 0,
            "fans": 0,
    ...
    def _get_default_coach_settings(self) -> dict:
        return {
            "P1Control": 0,
            "defensiveCones": 0,
            "defensivePlayCalling": 0,
            "homeUniform": 0,
            "lateGameFouling": 0,
            "offensivePlayCalling": 0,
            "playIcons": 0,
            "positionLock": 0,
            "roadUniform": 0,
            "substitutions": 0,
    ...
    def _get_default_difficulty(self) -> dict:
        return {
            "CPUPlayerSpeed": 5,
            "CPUReactionTime": 5,
            "CPUShotTiming": 5,
            "defensiveAssistance": 5,
            "offensiveAssistance": 5,
            "shotSpeed": 5,
            "shotStyle": 0,
        }

    def _get_default_sliders(self) -> dict:
        return {
            "blockSuccessRate": 5,
            "contestedShotStrength": 5,
            "dunkAccuracy": 5,
            "fatigueStrength": 5,
            "freeThrowAccuracy": 5,
            ...
            "layupAccuracy": 5,
            "midrangeAccuracy": 5,
            "shootingFoulFrequency": 5,
            "stealSuccessRate": 5,
            "threePointAccuracy": 5,
        }

    def _get_default_records(self) -> dict:
        return {
            "finals": {},
            "playoffs": {},
            "season": {},

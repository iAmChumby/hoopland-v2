...
class TestGeneratorQuick(unittest.TestCase):
    ...
    def test_generate_league_flow(self, mock_repo_cls, mock_init_db):
        ...
        mock_session.query.return_value.filter_by.return_value.all.return_value = [mock_player]
        
        # Mock Team Info lookup
        mock_repo.nba_client.get_team_by_id.return_value = {'city': 'Cleveland', 'nickname': 'Cavaliers', 'abbreviation': 'CLE'}

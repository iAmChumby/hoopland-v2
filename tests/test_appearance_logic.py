...
class TestFacialHairClassification:
    ...
    def test_classify_full_beard(self):
        ...
        assert mapping_loader.classify_facial_hair_density("Full Dark Beard") == "full_beard"
...
class TestIntegrationAppearance:
    ...
    def test_james_harden_has_beard(self):
        ...
        assert result["facial_hair"] not in [0, 16], f"Expected Harden to have beard, got index {result['facial_hair']}"
